...
const int LEFT_STEERING_TARGET_LIMIT = 1000; //980
const int RIGHT_STEERING_TARGET_LIMIT = 980; //900
...
const float LEFT_STEERING_GAIN = 1.00f;//1.15f
...
const int STEERING_CENTER_TRIM = 120; //120
...
const int STEERING_POSITION_DEADBAND = 20; //65
const int STEERING_SLOW_ZONE = 180; //220

// Conservative initial PWM values for first vehicle testing.
const int STEERING_MIN_PWM = 80; //72
const int STEERING_MAX_PWM = 200; //150
const int STEERING_SLOW_MAX_PWM = 130; //105;
...
const int STEERING_HARD_GUARD = 1000; //975
...
const int DRIVE_MIN_EFFECTIVE_PWM = 175;
...
int applySteeringCommandCompensation(int command)
{
  ...
  if (command >= 1000) {
    return RIGHT_STEERING_TARGET_LIMIT;
  }
