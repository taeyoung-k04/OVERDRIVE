...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data", type=Path, default=Path("dataset/lane_detection_with_crossswalk/yolo_lane_sem_class_crop/data.yaml"))
    parser.add_argument("--model", default="weights/yolo26n-sem-ade20k.pt")
    parser.add_argument("--epochs", type=int, default=200)
    parser.add_argument("--imgsz", type=int, default=640)
    parser.add_argument("--batch", type=int, default=2)
    parser.add_argument("--device", default="cpu")
    parser.add_argument("--project", type=Path, default=Path("yolo_lane_sem_class_crop"))
